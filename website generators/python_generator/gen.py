...
bg = "tb3_rev.mp4"
datas.append([[ttl, dt, lns, info, bg]])
...
ttl = "Website generation"
dt = "Automate all repetitive tasks"
info = """Each page on this website was generated using simple text as input. <br>The goal is to allow straightforward expansion with new projects!<br>
\t\t\t\t
<br>You can find more information and source code on the GitHub page. 
